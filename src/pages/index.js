            ...
            <div className={classes.root}>
                ...
                <AppBar position="static" color="default">
                    <Tabs
                        ...
                        centered
                    >
                        <Tab className={classes.tab} label="Overall Queries"/>
                ...
                >
                    <TabContainer dir={theme.direction}>
                        <ExpansionPanel>
                            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                                <Typography className={classes.heading}>
                                    In the latest decade, what disease had the highest number of death?(1947-1956)?
                                </Typography>
                            </ExpansionPanelSummary>
                            <ExpansionPanelDetails>
                                <Table className={classes.table}>
                                    ...
                                    <TableBody>
                                        <TableRow className={classes.row}>
                                            <CustomTableCell>Pneumonia</CustomTableCell>
                                            <CustomTableCell numeric>17925</CustomTableCell>
                                        </TableRow>
                                        <TableRow className={classes.row}>
                                            <CustomTableCell>Influenza</CustomTableCell>
                                            <CustomTableCell numeric>1060</CustomTableCell>
                                        </TableRow>
                                    </TableBody>
                                </Table>
                            </ExpansionPanelDetails>
                        ...
                        <ExpansionPanel>
                            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                                <Typography className={classes.heading}>
                                    In the latest decade, what location had the highest death number?(1947-1956)?
                                </Typography>
                            </ExpansionPanelSummary>
                            <ExpansionPanelDetails>
                                <GeoChart
                                    data={[['CHICAGO', 1946], ['PHILADELPHIA', 1419], ['BOSTON', 768], ['DETROIT', 765], ['PITTSBURGH', 683]]}
                                    library={{ region: "US", displayMode: "text", colorAxis: { colors: ['red'] } }}/>
                                <BarChart
                                    data={[['CHICAGO', 1946], ['PHILADELPHIA', 1419], ['BOSTON', 768], ['DETROIT', 765], ['PITTSBURGH', 683]]}/>
                            </ExpansionPanelDetails>
                        </ExpansionPanel>
                        <ExpansionPanel>
                            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                                <Typography className={classes.heading}>
                                    In the first 50 years, what disease had the highest number of death?(1888-1937)?
                                </Typography>
                            </ExpansionPanelSummary>
                            <ExpansionPanelDetails>
                                <ColumnChart
                                    data={[['Tuberculosis', 902240], ['Pneumonia', 623257], ['Diphtheria', 134645], ['Typhoid fever', 94807], ['Influenza', 75170]]}/>
                            </ExpansionPanelDetails>
                        </ExpansionPanel>
                        <ExpansionPanel>
                            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                                <Typography className={classes.heading}>
                                    In the first 50 years, what location had the highest death number?(1888-1937)?
                                </Typography>
                            </ExpansionPanelSummary>
                            <ExpansionPanelDetails>
                                <GeoChart
                                    data={[['CHICAGO', 264869], ['PHILADELPHIA', 219147], ['BOSTON', 93645], ['DETROIT', 72014], ['CLEVELAND', 67017]]}
                                    library={{ region: "US", displayMode: "text", colorAxis: { colors: ['red'] } }}/>
                                <BarChart
                                    data={[['CHICAGO', 264869], ['PHILADELPHIA', 219147], ['BOSTON', 93645], ['DETROIT', 72014], ['CLEVELAND', 67017]]}/>
                            </ExpansionPanelDetails>
                        ...
                        <ExpansionPanel>
                            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                                <Typography className={classes.heading}>
                                    List top 5 amount of event "cases" of disease by descending order.
                                </Typography>
                            </ExpansionPanelSummary>
                            <ExpansionPanelDetails>
                                <ColumnChart
                                    data={[['Measles', 5062232], ['Scarlet fever', 1896396], ['Diphtheria', 1089562], ['Pertussis', 1086384], ['Influenza', 940861]]}/>
                            </ExpansionPanelDetails>
                        </ExpansionPanel>
                        <ExpansionPanel>
                            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                                <Typography className={classes.heading}>
                                    List top 5 location with largest amount of event "case" by descending order.
                                </Typography>
                            </ExpansionPanelSummary>
                            <ExpansionPanelDetails>
                                <GeoChart
                                    data={[['CHICAGO', 1399080], ['PHILADELPHIA', 840129], ['DETROIT', 665447], ['BOSTON', 525031], ['CLEVELAND', 507147]]}
                        ...
                        <ExpansionPanel>
                            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                                <Typography className={classes.heading}>
                                    Diphtheria counts compairson by week.
                                </Typography>
                            </ExpansionPanelSummary>
                            <ExpansionPanelDetails>
                                <LineChart
                                    data={[[1, 29123], [2, 28552], [3, 28405], [4, 26458], [5, 25735], [6, 24481], [7, 24110], [8, 23778], [9, 23004], [10, 22730], [11, 22500], [12, 20819], [13, 20181], [14, 20230], [15, 19885], [16, 20135], [17, 18542], [18, 19193], [19, 18859], [20, 18937], [21, 17976], [22, 17972], [23, 17846], [24, 17280], [25, 16921], [26, 14256], [27, 14352], [28, 13265], [29, 13068], [30, 12811], [31, 13014], [32, 13282], [33, 13670], [34, 13970], [35, 14904], [36, 17863], [37, 21666], [38, 25431], [39, 27804], [40, 31073], [41, 33741], [42, 36411], [43, 37320], [44, 37241], [45, 38733], [46, 37709], [47, 35373], [48, 35422], [49, 34400], [50, 31255], [51, 28743], [52, 28936], [53, 5634]]}/>
                            </ExpansionPanelDetails>
                        </ExpansionPanel>
                        <ExpansionPanel>
                            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                                <Typography className={classes.heading}>
                                    Death rate of Diphtheria comparison (by decades).
                                </Typography>
                            </ExpansionPanelSummary>
                            <ExpansionPanelDetails>
                                <AreaChart
                                    data={[['1888-1897', 1.0], ['1898-1907', 0.4589], ['1908-1917', 0.0849], ['1918-1927', 0.0443], ['1928-1937', 0.0], ['1938-1947', 0.0], ['1948-1957', 0.0]]}/>
                            </ExpansionPanelDetails>
                        </ExpansionPanel>
                        <ExpansionPanel>
                            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                                <Typography className={classes.heading}>
                                    Death rate of Measles comparison (by year).
                                </Typography>
                            </ExpansionPanelSummary>
                            <ExpansionPanelDetails>
                                <AreaChart
                                    data={[[1888, 1.0], [1891, 1.0], [1894, 1.0], [1897, 1.0], [1900, 1.0], [1903, 1.0], [1906, 0.2655], [1909, 0.0188], [1912, 0.0142], [1915, 0.0108], [1918, 0.0086], [1921, 0.0065], [1924, 0.0], [1927, 0.0], [1930, 0.0], [1933, 0.0], [1936, 0.0], [1939, 0.0], [1942, 0.0], [1945, 0.0], [1948, 0.0], [1953, 0.0]]}/>
                            </ExpansionPanelDetails>
                        </ExpansionPanel>
                        <ExpansionPanel>
                            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                            ...
                            <ExpansionPanelDetails>
                                <GeoChart
                                    data={[['CHICAGO', 178388], ['PHILADELPHIA', 90345], ['BOSTON', 67473], ['DETROIT', 63720], ['CLEVELAND', 47096]]}
                                    library={{ region: "US", displayMode: "text", colorAxis: { colors: ['red'] } }}/>
                                <BarChart
                                    data={[['CHICAGO', 178388], ['PHILADELPHIA', 90345], ['BOSTON', 67473], ['DETROIT', 63720], ['CLEVELAND', 47096]]}/>
                            </ExpansionPanelDetails>
                        ...
                        <ExpansionPanel>
                            ...
                            <ExpansionPanelDetails>
                                <Table className={classes.table}>
                                    ...
                                    <TableBody>
                                        <TableRow className={classes.row}>
                                            <CustomTableCell>OHIO</CustomTableCell>
                                            <CustomTableCell numeric>37</CustomTableCell>
                                        </TableRow>
                                    </TableBody>
                                </Table>
                            </ExpansionPanelDetails>
                        ...
                        <ExpansionPanel>
                            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                                <Typography className={classes.heading}>
                                    Find the top 5 deadly diseases from 1988-1956.
                                </Typography>
                            </ExpansionPanelSummary>
                            <ExpansionPanelDetails>
                                <ColumnChart
                                    data={[['Smallpox without rash', 1.0], ['Cholera', 1.0], ['Yellow fever', 0.9988], ['Pneumonia', 0.696], ['Typhus group rickettsial disease', 0.6541]]}/>
                            </ExpansionPanelDetails>
                        </ExpansionPanel>
                        <ExpansionPanel>
                            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                                <Typography className={classes.heading}>
                                    Count the number of cases whose name of disease contains "Measles".
                                </Typography>
                            </ExpansionPanelSummary>
                            <ExpansionPanelDetails>
                                <Table className={classes.table}>
                                    ...
                                    <TableBody>
                                        <TableRow className={classes.row}>
                                            <CustomTableCell>Case</CustomTableCell>
                                            <CustomTableCell numeric>5062232</CustomTableCell>
                                        </TableRow>
                                    </TableBody>
                                </Table>
                            </ExpansionPanelDetails>
                        ...
                        <ExpansionPanel>
                            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                                <Typography className={classes.heading}>
                                    Find 5 cities in pennsylvania with highlest overall death rate of Tuberculosis from 1906-1956.
                                </Typography>
                            </ExpansionPanelSummary>
                            <ExpansionPanelDetails>
                                <GeoChart
                                    data={[['POTTSTOWN', 0.6613], ['TITUSVILLE', 0.5333], ['ALTOONA', 0.5161], ['READING', 0.51], ['PHILADELPHIA', 0.4885]]}
                                    library={{ region: "US", displayMode: "text", colorAxis: { colors: ['red'] } }}/>
                                <BarChart
                                    data={[['POTTSTOWN', 0.6613], ['TITUSVILLE', 0.5333], ['ALTOONA', 0.5161], ['READING', 0.51], ['PHILADELPHIA', 0.4885]]}/>
                            </ExpansionPanelDetails>
                    ...
                    <TabContainer dir={theme.direction}>
                        <ExpansionPanel>
                            ...
                            <ExpansionPanelDetails>
                                <GeoChart
                                    data={[['CHICAGO', 264869], ['PHILADELPHIA', 219554], ['BOSTON', 93645], ['DETROIT', 72014], ['CLEVELAND', 67018]]}
                                    library={{ region: "US", displayMode: "text", colorAxis: { colors: ['blue'] } }}/>
                                <ColumnChart
                                    data={[['CHICAGO', 264869], ['PHILADELPHIA', 219554], ['BOSTON', 93645], ['DETROIT', 72014], ['CLEVELAND', 67018]]}/>
                            </ExpansionPanelDetails>
                        ...
                        <ExpansionPanel>
                            ...
                            <ExpansionPanelDetails>
                                <BarChart
                                    data={[['1920', 808450], ['1923', 551604], ['1928', 461138], ['1922', 426809], ['1918', 400813]]}/>
                            </ExpansionPanelDetails>
                        </ExpansionPanel>
                        <ExpansionPanel>
                            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                            ...
                            <ExpansionPanelDetails>
                                <ColumnChart
                                    data={[['CHICAGO', 287812], ['PHILADELPHIA', 236522], ['BOSTON', 102418], ['DETROIT', 81828], ['CLEVELAND', 74220], ['PITTSBURGH', 73296], ['NEW ORLEANS', 70690], ['LOS ANGELES', 66339], ['WASHINGTON', 58610], ['CINCINNATI', 55906]]}/>
                            </ExpansionPanelDetails>
                        </ExpansionPanel>
                        <ExpansionPanel>
                            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                            ...
                            <ExpansionPanelDetails>
                                <GeoChart
                                    data={[['KEARNEY', 1], ['PORTAGE', 1], ['FOUNTAIN', 1], ['FULTON', 1], ['GRAND ISLAND', 1], ['BATAVIA', 1], ['MOUNT VERNON', 1], ['REVERE', 1], ['PORT RICHMOND', 1], ['RED WING', 1], ['SABINE PASS', 1], ['IRON MOUNTAIN', 1], ['MARIETTA', 1], ['GRAND HAVEN', 1], ['ROOSEVELT', 1], ['ARKANSAS CITY', 1], ['CLAREMONT', 1], ['ESCANABA', 1], ['MONTICELLO', 1], ['CHIPPEWA FALLS', 1]]}
                                    library={{ region: "US", displayMode: "text", colorAxis: { colors: ['blue'] } }}/>
                            </ExpansionPanelDetails>
                        </ExpansionPanel>
                        <ExpansionPanel>
                            ...
                            <ExpansionPanelDetails>
                                <GeoChart
                                    data={[['OHIO', 37], ['PENNSYLVANIA', 36], ['NEW JERSEY', 36], ['ILLINOIS', 35], ['MASSACHUSETTS', 35]]}
                    ...
                    <TabContainer dir={theme.direction}>
                        ...
                        <ExpansionPanel>
                            ...
                            <ExpansionPanelDetails>
                                <GeoChart
                                    data={[['YORK', 116], ['YONKERS', 3818], ['WORCESTER', 17713], ['WOODLAWN', 15], ['WOBURN', 655], ['WINSTON-SALEM', 4790], ['WILMINGTON', 2910], ['YOUNGSTOWN', 2487], ['WEST TAMPA', 18], ['WEST SPRINGFIELD', 51], ['WEST NEWTON', 111], ['WESTFIELD', 259], ['WESTCHESTER', 3], ['WEST ALLIS', 7], ['WEBSTER', 54], ['WAUKESHA', 1], ['WATERTOWN', 145], ['WATERLOO', 59], ['WASHINGTON', 1], ['WAKEFIELD', 97]]}
                                    library={{ region: "US", displayMode: "markers", resolution: "provinces" }}/>
                            </ExpansionPanelDetails>
                        </ExpansionPanel>
                    ...
                    <TabContainer dir={theme.direction}>
                        ...
                        <ExpansionPanel>
                            ...
                            <ExpansionPanelDetails>
                                <GeoChart
                                    data={[['GRAND HAVEN', 1], ['CHIPPEWA FALLS', 1], ['MONTICELLO', 1], ['CLAREMONT', 1], ['REVERE', 1]]}
                                    library={{ region: "US", displayMode: "text", colorAxis: { colors: ['blue'] } }}/>
                            </ExpansionPanelDetails>
                        </ExpansionPanel>
                        <ExpansionPanel>
                            ...
                            <ExpansionPanelDetails>
                                <PieChart donut={true}
                                          data={[['Yellow fever', 1], ['Typhoid and paratyphoid fevers', 3923], ['Scarlet fever', 1896396], ['Rocky Mountain spotted fever', 54], ['Typhoid fever', 258318]]}/>
                                <BarChart
                                    data={[['Yellow fever', 1], ['Typhoid and paratyphoid fevers', 3923], ['Scarlet fever', 1896396], ['Rocky Mountain spotted fever', 54], ['Typhoid fever', 258318]]}/>
                            </ExpansionPanelDetails>
                        </ExpansionPanel>
